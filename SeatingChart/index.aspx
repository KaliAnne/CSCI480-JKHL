...
<body onload="OnLoad()" onbeforeunload="return OnClose();">
    ...
    <!-- Start menu at the top of the page, view existing and home are options -->
    <header>
        <nav id="nav">
            <ul>
    ...
    <div align="center">
        ...
        <form runat="server">
                ...
                <fieldset id="menuopt">
                    ...
                    <fieldset id="roominfo">
                        ...
                        <p>
                            Rows:
                            <br />
                            <asp:TextBox runat="server" ID="RoomRows" />
                        </p>
                        <p>
                            Columns:
                            <br />
                            <asp:TextBox runat="server" ID="RoomColumns" />
                        </p>

                        <br />

                        <!-- Button allows user to edit the room information -->
                    ...
                    <!-- Menu with options for program operation -->
            ...
            <!-- Take attendance information and capability starts here -->
            <section align="center">
                <fieldset id="atteninfo" align="center">
                    ...
                    <!-- Rows with student information in them -->
                    ...
                    <br />
                    <!-- Indication of the front of the classroom -->
